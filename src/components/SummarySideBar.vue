...
import { dbGetUserBookmarks, dbSetUserBookmarks } from "src/databaselib.js";
...
function carparkBookmarkToggle(carparkDetails) {
    ...
    if (currentUser.value) {
        dbSetUserBookmarks(bookmarkedCarparks.value, bookmarkedERP.value, currentUser.value.uid);
    }
}
